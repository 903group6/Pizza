...
modelName = "TEST-TEST-SVM-Norm-linear-CLauto-Add-JJ-RB-NN-VB-STEMS-COUNT-BINARY"
directoryName = "SVM"
...
masterPipe.buildModels(classifier, modelName, directoryName, modelOutpath,description, [1,2,3,4,7,8],trainFile, testFile)
